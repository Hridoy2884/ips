        ...
        <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <div class="p-4 sm:p-7">
            ...
            <div class="mt-5">
              ...
              @if (session('success'))
              <div class="mt-2 text-center bg-green-500 text-sm text-white rounded-lg p-4 mb-3" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-danger-label">
                {{ session('success') }}
              </div>
              ...
              @endif
                ...
                <div class="grid gap-y-4">
                  ...
                  <div>
                    ...
                    @error('email')
                      <p class="mt-2 text-sm text-red-500 dark:text-red-400" id="email-error">
                        {{ $message }}
                      </p>
