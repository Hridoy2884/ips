        ...
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200">Choose<span class="text-blue-500">Categories
                </span> </h1>
            ...
            <p class="mb-12 text-base text-center text-gray-500">
              Explore Smart Tech – Your One-Stop Destination for the Latest Gadgets, Innovations & Everyday Electronics
            </p>
          </div>
        </div>
