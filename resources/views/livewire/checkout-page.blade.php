				...
				<div class="mb-6">
					...
					<div class="grid grid-cols-2 gap-4 mt-4">
						<div>
							...
							<input wire:model="district" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none  @error('district')
								border-red-500
							@enderror   " id="district" type="text">
							</input>
							@error('district')
								<span class="text-red-500 text-sm mt-1">
									{{ $message }}
