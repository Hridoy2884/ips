    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class=""><img src=" /storage/images/logo_text.png", alt=""></span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">"Explore the Future of Smart Living with Our Premium Gadgets - From Wearables to Home Essentials, We've Got It All!"</p>
       ...
       <div class="relative ms-4">
        <img id="hero-image" class="w-full rounded-md transition-opacity duration-700 ease-in-out" src="/storage/images/console.png" alt="Gaming Headset">
      ...
      <script>
        ...
        "/storage/images/logo.png",
          "/storage/images/console.png",
          "/storage/images/gameover.png",
          "/storage/images/headphone.png",
          "/storage/images/shoppingGadget.png",
    ...
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-gray-200"> Choose Popular<span class="text-blue-500"> Brands
            </span> </h1>
...
<div class="bg-orange-200 py-20">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-gray-100"> Choose <span class="text-blue-500"> Categories
            </span> </h1>
          <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
            <div class="flex-1 h-2 bg-blue-200">
            </div>
