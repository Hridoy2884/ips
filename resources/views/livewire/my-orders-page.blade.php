                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Advance Amount</th>
                            ...
                            @foreach ($orders as $order)
                                @php
                                    ...
                                    $status = match($order->status) {
                                        ...
                                        'processing' => '<span class="bg-orange-500 py-1 px-3 rounded text-white shadow">Processing</span>',
                                        ...
                                        'canceled' => '<span class="bg-red-600 py-1 px-3 rounded text-white shadow">Canceled</span>',
                                        default => '',
                                    };

                                    // Payment Status Badges
                                    $payment_status = match($order->payment_status) {
                                        'pending' => '<span class="bg-orange-500 py-1 px-3 rounded text-white shadow">Pending</span>',
                                        'advanced' => '<span class="bg-blue-500 py-1 px-3 rounded text-white shadow">Advanced</span>',
                                        'paid' => '<span class="bg-green-700 py-1 px-3 rounded text-white shadow">Paid</span>',
