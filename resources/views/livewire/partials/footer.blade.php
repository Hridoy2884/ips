<footer class="bg-white w-full">
    <div class="w-full max-w-7xl py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            ...
            <!-- Brand -->
            <div class="col-span-full lg:col-span-2 text-center lg:text-left px-4 sm:px-6">
                <a href="#" aria-label="Brand"
                    class="text-xl sm:text-2xl font-bold text-green-700 block mb-2 leading-tight">
                    Jui Power Digital IPS
                </a>
                <p class="text-xs sm:text-sm text-gray-600 max-w-sm mx-auto lg:mx-0 leading-relaxed">
            ...
            <div class="col-span-1">
                ...
                <p class="text-sm text-gray-600">
                    At <strong>Jui Power Digital IPS</strong>, we deliver top-tier power backup systems for modern-day
                    needs. Every detail reflects quality and innovation.
                </p>
            </div>
            ...
            <div class="col-span-2">
                ...
                <div class="text-sm text-gray-600 space-y-2">
                    <p><strong>Phone:</strong>
                        <a href="tel:01713540038" class="hover:text-green-600 font-medium">01713-540038</a>
                    </p>
                    <p><strong>Email:</strong>
                        <a href="mailto:support@juipower.com"
                            class="hover:text-green-600 font-medium">support@juipower.com</a>
                    </p>
        ...
        <!-- Bottom Section -->
        <div
            class="mt-10 border-t pt-6 flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4">
            <p class="text-sm text-gray-500">© 2025 Jui Power Digital IPS. All rights reserved.</p>
